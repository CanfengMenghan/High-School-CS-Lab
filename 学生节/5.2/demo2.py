...
DISPLAYSURF = pygame.display.set_mode((1920,1080))# 设置窗口的大小，单位为像素
...
while True:
    while status==1:
        ...
        textRectObj1.center = (960, 75)# 设置显示对象的坐标
        ...
        describeRect2.center = (960, 1005)# 设置显示对象的坐标
        ...
        myimage1.center = (960, 540)# 设置显示对象的坐标
    ...
    while status==6:
        ...
        textRectObj6.center = (1540, 75)# 设置显示对象的坐标
        ...
        textRectObj9.center = (1870, 1005)# 设置显示对象的坐标
        ...
        textRectObj5.center = (1740, 75)# 设置显示对象的坐标
        ...
        textRectObj7.center = (960,540)# 设置显示对象的坐标
    ...
    while status==8:
        ...
        fontObj = pygame.font.Font('SIMYOU.TTF', 80)# 通过字体文件获得字体对象
        textSurfaceObj7 = fontObj.render("右上角显示时间与正确数，请单击以继续", True, (255,255,255), (0,74,128))# 配置要显示的文字
        textRectObj7 = textSurfaceObj7.get_rect()# 获得要显示的对象的rect
        textRectObj7.center = (960,540)# 设置显示对象的坐标
        DISPLAYSURF.blit(textSurfaceObj7, textRectObj7)# 绘制字体
    ...
    while status==4:
        ...
        textRectObj9 = textSurfaceObj9.get_rect()# 获得要显示的对象的rect
        textRectObj9.center = (1280, 270)# 设置显示对象的坐标
        DISPLAYSURF.blit(textSurfaceObj9, textRectObj9)# 绘制字体
        ...
        textRectObj10.center = (1280, 540)# 设置显示对象的坐标
        ...
        textRectObj11.center = (1280, 810)# 设置显示对象的坐标
        ...
        textRectObj12.center = (640, 810)# 设置显示对象的坐标
        ...
        textRectObj12 = textSurfaceObj12.get_rect()# 获得要显示的对象的rect
        textRectObj12.center = (640, 270)# 设置显示对象的坐标
        DISPLAYSURF.blit(textSurfaceObj12, textRectObj12)# 绘制字体

        textSurfaceObj12 = fontObj.render('论语集锦', True, (255,255,255), (0,74,128))# 配置要显示的文字
        textRectObj12 = textSurfaceObj12.get_rect()# 获得要显示的对象的rect
        textRectObj12.center = (640, 540)# 设置显示对象的坐标
        DISPLAYSURF.blit(textSurfaceObj12, textRectObj12)# 绘制字体
        ...
        while status==4:
            ...
            for event in pygame.event.get():#获得事件
                ...
                if event.type==pygame.MOUSEBUTTONDOWN and 1330>=event.pos[0]>=1230 and 245<=event.pos[1]<=295: #判断鼠标位置以及是否摁了下去。
                    #print(1)
                    #DISPLAYSURF.blit(myimage,[200,200]) #在100,100的地方画出这个图片（100和100为左部和上部）
                    status=5
                    pygame.display.flip()
                ...
                if event.type==pygame.MOUSEBUTTONDOWN and 1330>=event.pos[0]>=1230 and 525<=event.pos[1]<=575: #判断鼠标位置以及是否摁了下去。
                    #print(1)
                    #DISPLAYSURF.blit(myimage,[200,200]) #在100,100的地方画出这个图片（100和100为左部和上部）
                    status=5
                    pygame.display.flip()
                ...
                if event.type==pygame.MOUSEBUTTONDOWN and 1330>=event.pos[0]>=1230 and 785<=event.pos[1]<=835: #判断鼠标位置以及是否摁了下去。
                    #print(1)
                    #DISPLAYSURF.blit(myimage,[200,200]) #在100,100的地方画出这个图片（100和100为左部和上部）
                    status=5
                    pygame.display.flip()
                ...
                if event.type==pygame.MOUSEBUTTONDOWN and 690>=event.pos[0]>=590 and 245<=event.pos[1]<=295: #判断鼠标位置以及是否摁了下去。
                    #print(1)
                    #DISPLAYSURF.blit(myimage,[200,200]) #在100,100的地方画出这个图片（100和100为左部和上部）
                    status=5
                    pygame.display.flip()
                ...
                if event.type==pygame.MOUSEBUTTONDOWN and 690>=event.pos[0]>=590 and 525<=event.pos[1]<=575: #判断鼠标位置以及是否摁了下去。
                    #print(1)
                    #DISPLAYSURF.blit(myimage,[200,200]) #在100,100的地方画出这个图片（100和100为左部和上部）
                    status=5
                    pygame.display.flip()
                ...
                if event.type==pygame.MOUSEBUTTONDOWN and 690>=event.pos[0]>=590 and 785<=event.pos[1]<=835: #判断鼠标位置以及是否摁了下去。
                    #print(1)
                    #DISPLAYSURF.blit(myimage,[200,200]) #在100,100的地方画出这个图片（100和100为左部和上部）
                    status=5
                    pygame.display.flip()
    ...
    while status==5:
        ...
        while status==5:
            ...
            for event in pygame.event.get():#获得事件
                ...
                if event.type==pygame.MOUSEBUTTONDOWN and 910<=event.pos[0]<=1010 and 245<=event.pos[1]<=295: #判断鼠标位置以及是否摁了下去。
                    #print(1)
                    #DISPLAYSURF.blit(myimage,[200,200]) #在100,100的地方画出这个图片（100和100为左部和上部）
                    status=2
                    pygame.display.flip()
                ...
                if event.type==pygame.MOUSEBUTTONDOWN and 910<=event.pos[0]<=1010 and 525<=event.pos[1]<=575: #判断鼠标位置以及是否摁了下去。
                    #print(1)
                    #DISPLAYSURF.blit(myimage,[200,200]) #在100,100的地方画出这个图片（100和100为左部和上部）
                    status=2
                    pygame.display.flip()
                ...
                if event.type==pygame.MOUSEBUTTONDOWN and 910<=event.pos[0]<=1010 and 785<=event.pos[1]<=835: #判断鼠标位置以及是否摁了下去。
                    #print(1)
                    #DISPLAYSURF.blit(myimage,[200,200]) #在100,100的地方画出这个图片（100和100为左部和上部）
                    status=2
                    pygame.display.flip()
        ...
        while currenttime<totaltime and status==2:
           ...
           # print(pasttime)
            ...
            for event in pygame.event.get():#获得事件
                ...
                if event.type==pygame.MOUSEBUTTONDOWN and 1830<=event.pos[0]<=1930 and 980<=event.pos[1]<=1030: #判断鼠标位置以及是否摁了下去。
                    #print(1)
                    #DISPLAYSURF.blit(myimage,[200,200]) #在100,100的地方画出这个图片（100和100为左部和上部）
                    status=3
